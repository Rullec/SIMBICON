...
*/
Image::Image(Image &img) { *this = img; }
...
{
    int location =
        IMAGELOCATION(this, x, y, ((nrBytesPerPixel == 1) ? (0) : (0)));
    return GETIMAGEAT(this, location);
}
...
{
    int location =
        IMAGELOCATION(this, x, y, ((nrBytesPerPixel == 1) ? (0) : (1)));
    return GETIMAGEAT(this, location);
}
...
{
    int location =
        IMAGELOCATION(this, x, y, ((nrBytesPerPixel == 1) ? (0) : (2)));
    return GETIMAGEAT(this, location);
}
...
void Image::convertToGrayScale()
{
    ...
    for (int i = 0; i < m; i++)
        for (int j = 0; j < n; j++)
        {
            ...
            newValue = (GETIMAGEAT(this, nrBytesPerPixel * (i * n + j) + 0) +
                        GETIMAGEAT(this, nrBytesPerPixel * (i * n + j) + 1) +
                        GETIMAGEAT(this, nrBytesPerPixel * (i * n + j) + 2)) /
                       3;
...
*/
Image *Image::duplicate() { return new Image(*this); }
