...
public:
	...
	*/
    inline double getRestitutionCoefficient() { return props.epsilon; }

    /**
		This method returns the rigid body's coefficient of restitution
	*/
    inline double getFrictionCoefficient() { return props.mu; }
	...
	*/
    inline double getMass() { return props.mass; }
	...
	*/
    inline void setBodyID(int newID) { this->id = newID; }
    ...
    /**
		...
		frame axes)
	*/
    inline Vector3d getPMI() { return props.MOI_local; }
	...
	*/
    ...
    virtual ArticulatedFigure *getAFParent() { return NULL; }
};
