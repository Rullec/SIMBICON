...
struct ODE_RB_Map_struct
{
    dBodyID id;
    RigidBody *rb;
    ODE_RB_Map_struct(dBodyID newId, RigidBody *newRb)
    {
        this->id = newId;
        this->rb = newRb;
    }
...
public:
	...
	*/
    virtual void applyRelForceTo(RigidBody *b, const Vector3d &f,
                                 const Point3d &p);
	...
	*/
    virtual void applyForceTo(RigidBody *b, const Vector3d &f,
                              const Point3d &p);
