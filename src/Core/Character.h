...
private:
	...
	*/
    void setHeading(Quaternion heading, DynamicArray<double> *state,
                    int start = 0);
...
public:
	...
	*/
    inline ArticulatedRigidBody *getRoot() { return af->root; }
...
{
    return rot.getComplexConjugate()
        .decomposeRotation(SimGlobals::up)
        .getComplexConjugate();
}
...
public:
	...
	*/
    ...
    {
        return Vector3d(REDUCED_STATE_VAL(this, 0 + startIndex),
                        REDUCED_STATE_VAL(this, 1 + startIndex),
                        REDUCED_STATE_VAL(this, 2 + startIndex));
    }
	...
	*/
    ...
    {
        return Quaternion(REDUCED_STATE_VAL(this, 3 + startIndex),
                          REDUCED_STATE_VAL(this, 4 + startIndex),
                          REDUCED_STATE_VAL(this, 5 + startIndex),
                          REDUCED_STATE_VAL(this, 6 + startIndex));
    }
	...
	*/
    ...
    {
        return Vector3d(REDUCED_STATE_VAL(this, 7 + startIndex),
                        REDUCED_STATE_VAL(this, 8 + startIndex),
                        REDUCED_STATE_VAL(this, 9 + startIndex));
    }
	...
	*/
    ...
    {
        return Vector3d(REDUCED_STATE_VAL(this, 10 + startIndex),
                        REDUCED_STATE_VAL(this, 11 + startIndex),
                        REDUCED_STATE_VAL(this, 12 + startIndex));
    }
	...
	*/
    inline Quaternion getJointRelativeOrientation(int jIndex)
    {
        ...
        return Quaternion(REDUCED_STATE_VAL(this, 0 + offset),
                          REDUCED_STATE_VAL(this, 1 + offset),
                          REDUCED_STATE_VAL(this, 2 + offset),
                          REDUCED_STATE_VAL(this, 3 + offset));
    }
	...
	*/
    ...
    {
        int offset = startIndex + 13 + 7 * jIndex;
        return Vector3d(REDUCED_STATE_VAL(this, 4 + offset),
                        REDUCED_STATE_VAL(this, 5 + offset),
                        REDUCED_STATE_VAL(this, 6 + offset));
    }
	...
	*/
    inline double raptor_computeDistanceTo(ReducedCharacterState *other)
    {
        ...
        RelevantJoint joints[] = {{0, 1.5, 1},  {1, 1.5, 0.1}, {2, 1.5, 0.1},
                                  {7, 1, 0.05}, {8, 1, 0.05},  {6, 1.5, 0.05},
                                  {5, 1, 0.05}};
        double result = 0;
        Quaternion qa, qb;
        Vector3d va, vb;
        ...
        qa = computeHeading(this->getOrientation()).getComplexConjugate() *
             this->getOrientation();
        qb = computeHeading(other->getOrientation()).getComplexConjugate() *
             other->getOrientation();

        va = this->getOrientation().getComplexConjugate().rotate(
            this->getVelocity());
        vb = other->getOrientation().getComplexConjugate().rotate(
            other->getVelocity());
