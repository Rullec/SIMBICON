...
static ConKeyWord keywords[] = {
    ...
    {"ConCState", CON_CUSTOM_STATE_START},
    {"/ConCState", CON_CUSTOM_STATE_END},
    ...
    {"custom_trajectory", CON_CUSTOM_TRAJECTORY_START},
    {"/custom_trajectory", CON_CUSTOM_TRAJECTORY_END},
    ...
    {"custom_component", CON_CUSTOM_TRAJ_COMPONENT_START},
    {"/custom_component", CON_CUSTOM_TRAJ_COMPONENT_END},
...
int getConLineType(char *&buffer)
{
    ...
    {
        if (strncmp(buffer, keywords[i].keyWord, strlen(keywords[i].keyWord)) ==
            0)
        {
