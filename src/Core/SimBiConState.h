...
public:
	...
	*/
    ...
    /**
		default destructor.
	*/
    ~TrajectoryComponent() { delete bFeedback; }
	...
	*/
    inline Quaternion evaluateTrajectoryComponent(SimBiController *con,
                                                  Joint *j, int stance,
	...
	*/
    inline double computeFeedback(SimBiController *con, Joint *j, double phi,
	...
	*/
    void updateComponent(SimBiController *con, Joint *j,
                         Trajectory1D &newDTrajX, Trajectory1D &newDTrajZ,
                         Trajectory1D &newVTrajX, Trajectory1D &newVTrajZ,
                         Trajectory1D *oldDTrajX, Trajectory1D *oldDTrajZ,
                         Trajectory1D *oldVTrajX, Trajectory1D *oldVTrajZ,
                         int nbSamples);
...
public:
	...
	*/
    ...
    /**
		...
		and the d and v values used for feedback.
	*/
    inline Quaternion evaluateTrajectory(SimBiController *con, Joint *j,
                                         ...
                                         const Vector3d &d, const Vector3d &v)
    {
        ...
        for (uint i = 0; i < components.size(); i++)
            q = components[i]->evaluateTrajectoryComponent(con, j, stance, phi,
                                                           d, v) *
                q;
	...
	*/
    void updateComponents(SimBiController *con, Joint *j,
                          Trajectory1D &newDTrajX, Trajectory1D &newDTrajZ,
                          Trajectory1D &newVTrajX, Trajectory1D &newVTrajZ,
                          Trajectory1D *oldDTrajX, Trajectory1D *oldDTrajZ,
                          Trajectory1D *oldVTrajX, Trajectory1D *oldVTrajZ,
...
public:
	...
	*/
    inline double getStateTime() { return stateTime; }

    /**
		this method is used to retrieve the index of the next state 
	*/
    inline int getNextStateIndex() { return nextStateIndex; }

    /**
		this method is used to return the number of trajectories for this state
	*/
    inline int getTrajectoryCount() { return sTraj.size(); }
	...
	*/
    inline bool needTransition(double phi, double swingFootVerticalForce,
	...
	*/
    void updateDVTrajectories(SimBiController *con, Joint *j,
                              Trajectory1D &newDTrajX, Trajectory1D &newDTrajZ,
                              Trajectory1D &newVTrajX, Trajectory1D &newVTrajZ,
                              int nbSamples = 100);
