...
public:
	...
	*/
    static Vector3d computePDTorque(const Quaternion &qRel,
                                    const Quaternion &qRelD,
                                    const Vector3d &wRel, const Vector3d &wRelD,
                                    ControlParams *pdParams);
	...
	*/
    static void scaleAndLimitTorque(Vector3d *torque, ControlParams *pdParams,
