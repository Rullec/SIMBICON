...
double &Vector::operator[](int i) { return VECTOR_AT(this->matrix, i); }
/**
...
*/
void Vector::setToProductOf(const Matrix &A, const Matrix &B, bool transA,
                            bool transB)
{
...
*/
double Vector::get(int i) const { return VECTOR_AT(this->matrix, i); }

/**
	This method sets the value of the matrix at (i,j) to newVal.
*/
void Vector::set(int i, double newVal) { VECTOR_AT(this->matrix, i) = newVal; }

/**
 *  This method resize the vector to m row 1 col
*/
void Vector::resize(int m) { resizeTo(m, 1); }
/**
