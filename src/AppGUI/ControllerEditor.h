...
public:
	...
	*/
    ...
    {
        curveEditors.push_back(
            new CurveEditor(300 * curveEditors.size(), 0, 300, 200));
    ...
    inline SimBiConFramework *getFramework() { return conF; }
	...
	*/
	 ...
	 */
    virtual void getDodgeBallPosAndVel(double x, double y, double strength,
                                       Point3d *pos, Vector3d *vel);
};
