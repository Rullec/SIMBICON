 ...
 */
int ConsoleCmd(ClientData clientData, Tcl_Interp *interp, int argc,
               CONST84 char **argv)
{
 ...
 */
static int InterpreterCmd(ClientData clientData, Tcl_Interp *interp, int argc,
                          CONST84 char **argv)
{
    ConsoleInfo *info = (ConsoleInfo *)clientData;
...
int TkConsoleInit(Tcl_Interp *interp)
{
    ...
    if (Tcl_Init(consoleInterp) != TCL_OK || Tk_Init(consoleInterp) != TCL_OK)
    {
        Tcl_Release((ClientData)consoleInterp);
        return TCL_ERROR;
    }
...
int Tcl_AppInit(Tcl_Interp *interp)
{
    ...
    Tcl_CreateCommand(interp, "cls", cls, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "<", pipeIn, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "quit", quit, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "launch", launch, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "anim", animation, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "camera", camera, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);
    Tcl_CreateCommand(interp, "instantChar", instantChar, (ClientData)NULL,
                      (Tcl_CmdDeleteProc *)NULL);

    //and link some variables as well
    Tcl_LinkVar(interp, "slowdown",
                (char *)&Globals::animationTimeToRealTimeRatio,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "drawFPS", (char *)&Globals::drawFPS, TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawCubeMap", (char *)&Globals::drawCubeMap,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawGlobalAxes", (char *)&Globals::drawGlobalAxes,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawShadows", (char *)&Globals::drawShadows,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawCollisionPrimitives",
                (char *)&Globals::drawCollisionPrimitives, TCL_LINK_INT);
    Tcl_LinkVar(interp, "followCharacter", (char *)&Globals::followCharacter,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawCDPs", (char *)&Globals::drawCollisionPrimitives,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawJoints", (char *)&Globals::drawJoints,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawContactForces",
                (char *)&Globals::drawContactForces, TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawDesiredPose", (char *)&Globals::drawDesiredPose,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "showPushInterface",
                (char *)&Globals::drawPushInterface, TCL_LINK_INT);
    Tcl_LinkVar(interp, "showCurveEditor", (char *)&Globals::drawCurveEditor,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "showCanvas", (char *)&Globals::drawCanvas,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "toggleScreenshots", (char *)&Globals::drawScreenShots,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "toggleControlshots",
                (char *)&Globals::drawControlShots, TCL_LINK_INT);
    Tcl_LinkVar(interp, "toggleUpdateDVTraj", (char *)&Globals::updateDVTraj,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "toggleWorldshots", (char *)&Globals::drawWorldShots,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "forceHeadingControl",
                (char *)&SimGlobals::forceHeadingControl, TCL_LINK_INT);
    Tcl_LinkVar(interp, "drawGroundPlane", (char *)&Globals::drawGroundPlane,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "conInterpValue",
                (char *)&SimGlobals::conInterpolationValue, TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "currControlShot", (char *)&Globals::currControlShotStr,
                TCL_LINK_STRING);
    Tcl_LinkVar(interp, "targetPosePhase", (char *)&Globals::targetPosePhase,
                TCL_LINK_DOUBLE);
    //	Tcl_LinkVar(interp, "conInterpValue",			(char *) &SimGlobals::conInterpolationValue, TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "bipVel", (char *)&SimGlobals::bipDesiredVelocity,
                TCL_LINK_DOUBLE);
    ...
    Tcl_LinkVar(interp, "part1dTarget", (char *)&SimGlobals::targetPos,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "softness", (char *)&SimGlobals::constraintSoftness,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "cgitn", (char *)&SimGlobals::CGIterCount,
                TCL_LINK_INT);
    Tcl_LinkVar(interp, "lincnt", (char *)&SimGlobals::linearizationCount,
                TCL_LINK_INT);

    Tcl_LinkVar(interp, "rootSagittal", (char *)&SimGlobals::rootSagittal,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "rootLateral", (char *)&SimGlobals::rootLateral,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "swingHipSagittal",
                (char *)&SimGlobals::swingHipSagittal, TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "swingHipLateral", (char *)&SimGlobals::swingHipLateral,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "stanceAngleSagittal",
                (char *)&SimGlobals::stanceAngleSagittal, TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "stanceAngleLateral",
                (char *)&SimGlobals::stanceAngleLateral, TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "stanceKnee", (char *)&SimGlobals::stanceKnee,
                TCL_LINK_DOUBLE);

    Tcl_LinkVar(interp, "comX", (char *)&SimGlobals::COMOffsetX,
                TCL_LINK_DOUBLE);
    Tcl_LinkVar(interp, "comZ", (char *)&SimGlobals::COMOffsetZ,
                TCL_LINK_DOUBLE);
 ...
 */
int pipeIn(ClientData clientData, Tcl_Interp *interp, int argc,
           CONST84 char **argv)
{
    if (argc < 2)
    {
