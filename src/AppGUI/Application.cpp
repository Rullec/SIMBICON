 ...
 * Constructor.
 */
Application::Application(void) { registerTclFunctions(); }
 ...
 */
Point3d Application::getCameraTarget() { return Point3d(0, 1, 0); }
...
void Application::drawGround()
{
    ...
    glVertex3d(x, (-x * Globals::a - z * Globals::c - Globals::d) / Globals::b,
               z);
    z = -size;
    glTexCoord2d(x / 2, z / 2);
    glVertex3d(x, (-x * Globals::a - z * Globals::c - Globals::d) / Globals::b,
 ...
 */
bool Application::onMouseEvent(int eventType, int button, int mouseX,
                               int mouseY)
{
    return false;
}
 ...
 */
bool Application::onKeyEvent(int key) { return false; }
