...
public:
    ...
    void addPoint(const Point3d &newPoint) { points.push_back(newPoint); }
    ...
    static bool intersectSegments(Point3d &start1, Point3d &end1,
...
public:
    ...
    PolygonPrimitive(const PolygonPrimitive &other) : PointPrimitive(other) {}
    ...
    int intersectWithSegment(Point3d &segmentStart, Point3d &segmentEnd,
                             Point3d &intersection,
...
public:
    ...
    CurvePrimitive(const CurvePrimitive &other) : PointPrimitive(other) {}
